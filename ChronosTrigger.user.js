...
// @resource     fa_css https://raw.githubusercontent.com/bryfry/chronos_trigger/master/font-awesome.css
// @grant        GM_addStyle
// @grant        GM_getResourceText
// ==/UserScript==

// NOTE: I'm just rehosting this for bryfry, cause the version on his page is currently busted, due to an updateURL issue.  
// I could reach out to him I suppose, but that just takes effort.  This is solely for my own benefit, and this should not 
// be viewed as an attempt to take credit for a great man's work.  Bryfry, you are an hero.
...
function resizeView(delay){
    if (delay) {
        setTimeout(function(){
            ...
            $("#console").css("height","auto");  // ?_?
            console.log("resized!!!");
        },delay);
    } else {
        $("#mainCanvas").fitToParent();
    }
    $("#console").css('top',0); // see note in Make things pretty: ?_?
    $("#console").css("position","relative");  // ?_?
    $("#console").css("height","auto");  // ?_?
    $("#mainCanvas").css("position","relative");  // ?_?
}
...
(function() {
    ...
    //   You will find these jqery css manipulations annotated with a ?_?. This
